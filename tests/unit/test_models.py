...
def test_coin_price_happy_path(sample_price_response):
    price = CoinPrice.from_api_response(data=sample_price_response, coin_id="bitcoin", currency="usd")
...
def test_coin_price_different_currency():
    ...
    price = CoinPrice.from_api_response(data=data, coin_id="ethereum", currency="eur")
...
def test_coin_price_invalid_coin(sample_price_response):
    with pytest.raises(KeyError):
        CoinPrice.from_api_response(data=sample_price_response, coin_id="notacoin", currency="usd")
